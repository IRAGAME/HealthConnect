      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">
            {t('hospital.chooseHospital')}
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            {t('hospital.selectForAppointment')}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {hospitals.map((hospital) => (
            ...
            >
              ...
              {/* Contact Info */}
              <div className="space-y-2 text-xs text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-3 mb-4">
              ...
              <button
                onClick={() => handleSelectHospital(hospital.id)}
                className="w-full px-4 py-2 rounded-lg text-white font-semibold transition-all hover:opacity-90"
